...
export default async function Footer() {
  ...
  return (
    ...
    >
      ...
      {/* Logo */}
      <Logo className="footer-logo absolute bottom-[-7vw] overflow-visible mask-b-from-20% mask-b-to-100% fill-transparent stroke-(--footer-text) stroke-1 pt-px pr-3 sm:px-7" />
    </footer>
  );
}
