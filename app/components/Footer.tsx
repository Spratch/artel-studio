...
export default async function Footer() {
  ...
  return (
    <footer className="relative flex min-h-(--h-section) grid-cols-6 flex-col content-start gap-x-2.5 gap-y-10 overflow-hidden bg-ardoise px-3 pt-16 pb-44 font-serif text-creme sm:grid sm:gap-y-17 sm:px-6 sm:pt-34 sm:pb-96 xl:pb-180">
      {/* Contact */}
