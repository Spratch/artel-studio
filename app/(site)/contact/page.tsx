...
export default async function Contact({
  ...
  const contact = await getContactPage({ searchParams: { preview } });
  ...
  return (
    <>
      ...
      >
        ...
        <Logo className="footer-logo fixed bottom-[-7vw] z-0 w-[calc(100vw-24px)] mask-b-from-20% mask-b-to-100% fill-transparent stroke-creme stroke-1 pt-px sm:px-7" />
      </main>
