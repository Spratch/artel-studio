...
// Query: *[_type == "home"][0]{    "intro": intro{      type,      "video": video{        "playbackId": coalesce(asset->playbackId, "")      },      "project": projectRef->{  "slug": slug.current,  cover,  "tags": services[]->{    name  },  "client": client->{    name,    logo  }},    },    "logoColor": logoColor->value,    "sections": sections[]{  _type,  ...select(    _type == "mediasSection" => {      _type,      "medias": medias[]    },    _type == "section" => {      _type,      title,      subtitle,      "colors": colors{        "backgroundColor": backgroundColor->value,        "textColor": textColor->value,        "servicesColor": servicesColor->value,        "reviewsColor": reviewsColor->value,        "methodStepColor": methodStepColor->value,        "methodTitleColor": methodTitleColor->value,        "buttonBgColor": buttonBgColor->value,        "buttonFgColor": buttonFgColor->value      },      "button": button{        label,        "page": page->{          "title": coalesce(title, name),          "slug": select(            _type == "project" => "projet/" + slug.current,            title != null => slug.current,            name != null => "services/" + slug.current,          )        },        position      },      "description": description{        layout,        "col1": column1[]{  ...,  markDefs[]{    ...,    _type == "internalLink" => {      ...,      "slug": *[_id == ^._ref][0].slug.current,      "refType": *[_id == ^._ref][0]._type    }  }},        "col2": column2[]{  ...,  markDefs[]{    ...,    _type == "internalLink" => {      ...,      "slug": *[_id == ^._ref][0].slug.current,      "refType": *[_id == ^._ref][0]._type    }  }},        "col3": column3[]{  ...,  markDefs[]{    ...,    _type == "internalLink" => {      ...,      "slug": *[_id == ^._ref][0].slug.current,      "refType": *[_id == ^._ref][0]._type    }  }},      },      contentType,      "content": select(        contentType == "method" => {          "type": "method",          "method": methodObject.method,          "settings": coalesce(methodObject.settings, {            "direction": "mixed",            "speedRange": {"min":26,"max":46},            "gapRange": {"min":20,"max":96}          }),        },        contentType == "medias" => {          "type": "medias",          "medias": medias[]        },        contentType == "reviews" => {          "type": "reviews",          "settings": coalesce(reviewsObject.settings, {            "direction": "mixed",            "speedRange": {"min":26,"max":46},            "gapRange": {"min":20,"max":96}          }),          "reviews": reviewsObject.reviews[]->{            "person": person->{              name,              position,            },            "client": client->name,            "slug": slug.current,            "text": text[]{  ...,  markDefs[]{    ...,    _type == "internalLink" => {      ...,      "slug": *[_id == ^._ref][0].slug.current,      "refType": *[_id == ^._ref][0]._type    }  }}          }        },        contentType == "projects" => {          "type": "projects",          "projects": projects[]->{  "slug": slug.current,  cover,  "tags": services[]->{    name  },  "client": client->{    name,    logo  }}        },        contentType == "services" => {          "type": "services",          "services": coalesce(            services[]->{              name,              "slug": slug.current            },            *[_type == "service" && !(_id == ^._id)]{              name,              "slug": slug.current            }          )        }      )    }  )}  }
